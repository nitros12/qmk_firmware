...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----+-----+-----+-----+------+		   |--------------------------------|
     * |  F6  | F7  | F8  | F9  | F10 |      | PGDN|C(DWN)|C(UP)| PGUP| VOLDN |
     * `------+-----+-----+------+----'		   `--------------------------------'
     *  				.-----------------.           .-----------------.
     *  				| F11 | F12|	  	|						|     | ALT |     |
     *  				'-----------------'           '-----------------'
    ...
    [NUMB] = LAYOUT_gergoplex(KC_1,  KC_2,  KC_3,   KC_4,   KC_5,     KC_6,    KC_7,       KC_8,     KC_9,    KC_0,
                              ...
                              KC_F6, KC_F7, KC_F8,  KC_F9,  KC_F10,   KC_PGDN, C(KC_DOWN), C(KC_UP), KC_PGUP, KC_VOLD, 

                                            KC_F11, KC_F12, KC_TRNS,  KC_TRNS, KC_LALT,    KC_TRNS)};
