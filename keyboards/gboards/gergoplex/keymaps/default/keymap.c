...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `------+-----+-----+------+----'		   `--------------------------------'
     *  .-------------------------.           .-----------------.
     *  |ESC/META|TAB/ALT|SPC(SYM)|           |SPC(NUM)|ENT|BSPC|
     *  '-------------------------'           '-----------------'
     */
    [BASE] = LAYOUT_gergoplex(KC_Q,               KC_W, KC_E, KC_R, KC_T,    KC_Y, KC_U, KC_I, KC_O, KC_P, 
                              ...
                              MT(MOD_LGUI, KC_ESC), MT(MOD_LALT, KC_TAB), LT(SYMB, KC_SPC),  // Left
     ...
     *  				'-----------------'           '------------------'
     */
    [SYMB] = LAYOUT_gergoplex(KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE,    KC_GRV,  KC_TILD, KC_TRNS, KC_TRNS, KC_BSLS,
